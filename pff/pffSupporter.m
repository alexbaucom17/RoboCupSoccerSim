function f_total = pffSupporter(dball,dshotpath,dshotpathDef,dgoalAtt,dgoalDef,in6,in7)
%PFFSUPPORTER
%    F_TOTAL = PFFSUPPORTER(DBALL,DSHOTPATH,DSHOTPATHDEF,DGOALATT,DGOALDEF,IN6,IN7)
